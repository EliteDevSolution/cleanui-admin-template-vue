            ...
            <div :class="$style.orderLeft">
              <div :class="$style.table">
                ...
                >
                  ...
                  <a slot="sell" href="javascript: void(0);" class="utils__link--blue mr-2">
                    <strong>SELL</strong>
                  </a>
                </a-table>
              </div>
            </div>
            <div :class="$style.orderMiddle">
                    ...
                    <div class="my-3 text-center">
                      ...
                      <div>
                        <a
                          ...
                          class="utils__link--blue utils__link--underlined"
                        >
...
export default {
  ...
  data: function () {
    ...
    const option = {
      ...
      xAxis: {
        type: 'category',
        data: dates,
        axisLine: { lineStyle: { color: '#514d6a' } },
      },
      yAxis: {
        scale: true,
        axisLine: { lineStyle: { color: '#514d6a' } },
  ...
  methods: {
    ...
    handleMyOpenOrders() {
      this.myOpenOrders.loading = true
      setTimeout(() => {
        this.myOpenOrders.loading = false
        this.myOpenOrders.loaded = true
      }, 1500)
    },
    handleMyOrderHistory() {
      this.myOrderHistory.loading = true
      setTimeout(() => {
        this.myOrderHistory.loading = false
        this.myOrderHistory.loaded = true
      }, 1500)
    },
  },
}
