<template>
  <div>
    <div class="kit__utils__heading">
      <h5>
        <span class="mr-3">Typography</span>
        <a
          href="https://getbootstrap.com/docs/4.3/content/typography/"
          target="_blank"
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="mb-5">
              ...
              <p class="text-muted">
                ...
                available.
                <code>.h1</code> through
                <code>.h6</code> classes are also available, for
          ...
          <div class="col-lg-6">
            ...
            <div class="mb-5">
              ...
              <h1>
                <i class="fe fe-home mr-3" aria-hidden="true"></i>Bootstrap heading
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <p class="text-muted">A list of terms with icons</p>
              <ul class="list-unstyled">
                <li>
                  <i class="fe fe-checkmark2 mr-2" aria-hidden="true"></i>
                ...
                <li>
                  <i class="fe fe-checkmark2 mr-2" aria-hidden="true"></i>Faucibus porta lacus fringilla
                  vel
                </li>
              </ul>
            </div>
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a
                    ...
                    aria-expanded="false"
                  >
                    <i class="fe fe-checkmark2 mr-2" aria-hidden="false"></i>
                    Nulla volutpat aliquam velit
                  </a>
                  <ul class="collapse" id="exampleSubmenu" aria-expanded="false">
                    <li>Phasellus iaculis neque</li>
                    <li>Purus sodales ultricies</li>
                  </ul>
                </li>
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <p class="text-muted">
                ...
                <code>display: inline-block;</code> and some
                light padding
              </p>
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <p class="text-muted">A list of terms with their associated descriptions</p>
              <dl>
          ...
          <div class="col-lg-8">
            ...
            <div class="mb-5">
              ...
              <p
                class="text-muted"
              >Use the well as a simple effect on an element to give it an inset effect</p>
              <dl class="row">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p class="text-muted">
              Add a
              <code>&lt;footer class="blockquote-footer"&gt;</code> for identifying the source.
